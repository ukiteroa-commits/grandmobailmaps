...
const STORES = [
  {
    name: 'Google Play',
    icon: '📱',
    url: 'https://play.google.com/store/apps/details?id=com.grandmobile.rp',
    color: '#3b82f6'
  },
  {
    name: 'App Store',
    icon: '🍎',
    url: 'https://apps.apple.com/app/grand-mobile-rp/id1234567890',
    color: '#8b5cf6'
  },
  {
    name: 'RuStore',
    icon: '🇷🇺',
    url: 'https://rustore.ru/app/com.grandmobile.rp',
    color: '#10b981'
  },
  {
    name: 'Официальный сайт',
    icon: '🌐',
    url: 'https://grandmobile.ru',
    color: '#f59e0b'
  }
];
